...
) => [
  {
    ...
    items: [
      ...
      },
      {
        ...
        shortcut: "###",
        keywords: ["h3", "heading3", "small title", "subsection", "minor heading"],
    ...
    items: [
      {
        ...
        shortcut: "-",
        keywords: ["ul", "unordered", "bullet list", "points", "bullets", "items"],
      ...
      },
      {
        ...
        shortcut: "1.",
        keywords: ["ol", "ordered", "number list", "sequence", "steps", "ranked"],
