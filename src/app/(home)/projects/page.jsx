...
export default function ProjectPage() {
	...
	// 🧩 Drawer state from HeroUI (isOpen = drawer visibility)
		...
		<div className="flex flex-col items-center justify-center min-h-screen px-4 space-y-6 text-center">
			<div className="max-w-xl">
				...
				<p className="mt-3 text-sm leading-relaxed text-gray-600">
					Great! You’ve created a workspace. Next, create one or more projects
					inside it. You can organize your documents, users, and access control
					per project.
				</p>
			</div>
