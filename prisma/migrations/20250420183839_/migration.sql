...
-- CreateIndex
CREATE INDEX "WorkspaceAdmin_workspaceId_idx" ON "WorkspaceAdmin"("workspaceId");

-- CreateIndex
CREATE INDEX "WorkspaceAdmin_userId_idx" ON "WorkspaceAdmin"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "WorkspaceAdmin_workspaceId_userId_key" ON "WorkspaceAdmin"("workspaceId", "userId");
...
-- AddForeignKey
ALTER TABLE "WorkspaceAdmin" ADD CONSTRAINT "WorkspaceAdmin_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkspaceAdmin" ADD CONSTRAINT "WorkspaceAdmin_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
